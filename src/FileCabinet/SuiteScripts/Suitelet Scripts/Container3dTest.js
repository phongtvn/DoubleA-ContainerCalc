        ...
        try {
            if (context.request.method === 'GET') {
                            ...
                            ${container.recommendedItems && Array.isArray(container.recommendedItems) && container.recommendedItems.length > 0 
                                ? "<ul>" + container.recommendedItems.map(function(item) {
                                    return "<li>" +
                                        ...
                                        /* "Width: " + (item.width ? parseFloat(item.width).toFixed(2) : "N/A") + "<br>" +
                                        "Diameter: " + (item.diameter ? item.diameter : "N/A") + "<br>" +
                                        "Weight: " + (item.weight ? parseFloat(item.weight).toFixed(2) : "N/A") + "<br>" + */ 
                ...
                <script>
                    try {   
                        ...
                        function init() { 
                            ...
                            // var light = new THREE.HemisphereLight(0xffffbb, 0x080820, 1); // แสงที่มาจากท้องฟ้า
                            // scene.add(light);
                        ...
                        function changeContainer(containerId) {
                            ...
                            // var leftWall = new THREE.Mesh(new THREE.PlaneGeometry(containerDepth, containerHeight), wallMaterial);
                            // leftWall.rotation.y = Math.PI / 2;
                            // leftWall.position.set(0, containerHeight / 2, containerDepth / 2);
                            // leftWall.receiveShadow = true; // ให้สามารถรับแสงได้
                            // containerGroup.add(leftWall);
                            //
                            // var topWall = new THREE.Mesh(new THREE.PlaneGeometry(containerWidth, containerDepth), wallMaterial);
                            // topWall.rotation.x = -Math.PI / 2;
                            // topWall.position.set(containerWidth / 2, containerHeight, containerDepth / 2);
                            // topWall.receiveShadow = true; // ให้สามารถรับแสงได้
                ...
                try {
                    ...
                    //     received3D: jsonResult3D ? true : false,
                    //     receivedConcal: jsonResultConcal ? true : false
                    // }));
                ...
                log.debug('Unsupported request method: ' + context.request.method);
            }
        } catch (error) {
