...
define([
    'N/error','N/file','N/record','N/runtime','N/search','N/cache','N/ui/serverWidget','N/redirect','N/https','N/url','./Calc/greedyCalc.js'],
function(error, file, record, runtime, search, cache, serverWidget, redirect, https, url, calc) {
    ...
    ItemProcessor.prototype = {
        ...
        processCopyPaper: function(itemData, specialConditions) {
            ...
            itemVariants.forEach((variant) => {
                ...
                if (!this.containers.boxesCutsize[parentKey]) {
                    this.containers.boxesCutsize[parentKey] = [];
                }
                
                this.containers.boxesCutsize[parentKey].push(processedItem);
            });
        },
        ...
        loadContainerData: function() {
            ...
            return {
                ...
                maxWeight: 0 // Will be set from special conditions
            };
        },
         ...
         */
        buildCutsizeItem: function(variant, itemData, weight, containerData) {
            ...
            return {
                ...
                binCutsize: containerData,
                uomConversionRates: uomRates.rates,
                tolerance: this.customerData.tolerance
            };
        },
